  ...
  return (
    <DashboardLayout>
            ...
            <div className={styles.headerWrapper}>
                <div>
                    ...
                    <p className={styles.headerSubtitle}>
                        {allResumes.length > 0 ? `You have ${allResumes.length} resumes${allResumes.length != 1 ?
                            's' : ''}` : 'Start building your professional resume'}
                    </p>
                </div>
            ...
            {loading && (
                ...
                <div className={styles.emptyStateWrapper}>
                    ...
                    <p className={styles.emptyText}>
                        You can create a new resume by clicking on the "Create Now" button above to land your dream job.
                    </p>
                    <button className={styles.createButton} onClick={() => setOpenCreateModal(true)}>
                ...
                <div className={styles.grid}>
                    ...
                    {allResumes.map((resume) => (
                        ...
                        isNew ={ dayjs().diff(dayjs(resume.createdAt), 'day') <= 30}
                    />
                    ))}
                </div>
                )}
        ...
        <Modal isOpen={openCreateModal} onClose={()=> setOpenCreateModal(false)}
            ...
            title='Confirm Deletion' showActionBtn actionBtnText='Delete' actionBtnClassNmae= 'bg-red-600 hover:bg-red-700'

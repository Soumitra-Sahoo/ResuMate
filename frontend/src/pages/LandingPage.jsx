                ...
                <button className={landingPageStyles.primaryButton} onClick={handleCTA}>
                  <div className={landingPageStyles.primaryButtonOverlay}>
                      ...
                      <span className={landingPageStyles.primaryButtonContent}>
                          Start Building
                          <ArrowRight className={landingPageStyles.primaryButtonContent} size={18}/>
                      </span>
                </button>
              ...
              <div className={landingPageStyles.statsContainer}>
                  {[
                     { value: '10K+', label: 'Resumes Created', gradient: 'from-violet-600 to-fuchsia-600' },
                                    ...
                                    { value: '2 Min', label: 'Build Time', gradient: 'from-emerald-500 to-teal-500' }
                  ].map((stat, idx) => (
                    <div className={landingPageStyles.statItem} key={idx}>
                        <div className={`${landingPageStyles.statNumber} ${stat.gradient}`}>
                            {stat.value}
                        </div>
                        <div className={landingPageStyles.statLabel}></div>
                    </div>
                  ))}
              </div>
            </div>
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              <h2  className={landingPageStyles.featureTitle}>
                  Why Choose <span  className={landingPageStyles.featuresTitleGradient}>ResuMate?</span>
              </h2>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
           ...
           <a href="https://www.linkedin.com/in/soumitrasahoo" target='_blank' className={landingPageStyles.footerLink}>
            Soumitra Sahoo
           </a>
          </p>
        </div>

...
export const ResumeSummaryCard = ({
    ...
    return (
        ...
        >
            {/* Hover background */}
            <div className="absolute inset-0 bg-gradient-to-br from-violet-100 via-transparent to-fuchsia-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            {/* Preview area */}
            <div className={`p-4 sm:p-6 flex-1 relative overflow-hidden bg-gradient-to-br ${designColor}`}>
                ...
                {isHovered && (
                    <div className="absolute inset-4 sm:inset-6 bg-gradient-to-t from-white/80 via-white/20 to-transparent flex items-end justify-center p-6 rounded-2xl">
    ...
    return (
        ...
        >
            {thumbnailImg ? (
                ...
                <div className="w-full h-[200px] flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 via-violet-600 to-fuchsia-50 rounded-2xl">

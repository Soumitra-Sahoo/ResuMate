...
export const Input = ({
  ...
  return (
    <div className="group">
      ...
      <div
        className={`relative flex items-center h-12 bg-gray-50 border-2 px-4 rounded-xl transition-all duration-300
    ${
      isFocused
      ...
      >
        <input
          ...
          className="w-full h-full bg-transparent outline-none text-gray-800 placeholder-gray-500 font-medium"
          value={value}
          onChange={onChange}
      ...
      {!previewUrl ? (
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/30 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-2">
            <button
              type="button"
              className="w-10 h-10 flex items-center justify-center bg-white/80 text-gray-800 rounded-full hover:bg-white transition-all"
              onClick={chooseFile}
            >
              <Edit size={16} />
            </button>
    ...
    <div className="flex items-center gap-3">
      {editing ? (
        <>
          ...
          />
          <button
            className="p-2 rounded-xl bg-violet-500 hover:bg-violet-600 text-white transition-all"

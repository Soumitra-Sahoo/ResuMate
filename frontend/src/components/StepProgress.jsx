...
const StepProgress = ({progress}) => {
  return (
    ...
    <div className=' relative w-full h-4 bg-white/5 backdrop-blur-2xl overflow-hidden rounded-fullborder border-white/10'>
    ...
    <div className=' flex justify-between items-center mt-3'>
        ...
        <div className=' flex items-center gap-2'>
                {progress >= 100 && (
                 <div className=' w-6 h-6 bg-gradient-to-r from-green-500 to-emerald-500 rounded-fullflex items-center justify-center'>
